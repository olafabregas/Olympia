    ...
    <>
      ...
      <div className="grid grid-rows-2 bg-black w-screen">
        <div className="bg-black pl-7 h-screen">
          <h1 className="text-white text-5xl font-semibold ml-11 mt-7 ">
            Movies
          </h1>
          <Carousel
          ...
          >
            <div
              style={{
                backgroundImage: `linear-gradient(to right,rgba(0,0,0,7),rgba(0,0,0,0.1)),url(https://image.tmdb.org/t/p/w500${
                  movie?.results ? movie?.results[1]?.poster_path : ""
                })`,
            ...
            <div
              style={{
                backgroundImage: `linear-gradient(to right,rgba(0,0,0,7),rgba(0,0,0,0.1)),url(https://image.tmdb.org/t/p/w500${
                  movie?.results ? movie?.results[2]?.poster_path : ""
                })`,
                backgroundRepeat: "no-repeat",
                backgroundSize: "1200px 600px"
              }}
            ...
            <div
              style={{
                backgroundImage: `linear-gradient(to right,rgba(0,0,0,7),rgba(0,0,0,0.1)),url(https://image.tmdb.org/t/p/w500${
                  movie?.results ? movie?.results[3]?.poster_path : ""
                })`,
                backgroundRepeat: "no-repeat",
                backgroundSize: "1200px 600px"
              }}
